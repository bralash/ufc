<?php 
	...
	$pageTitle = $siteInfo['abt_title'].' | '.$siteInfo['site_name'];
...
<link rel="canonical" href="https://www.ojaolawebsolution.com/"/>
...
<div class="about-w3layouts-agileinfo" style="min-height:400px;">
	<div class="container">
		<h3><?php echo $siteInfo['abt_title'];?></h3>
		<hr>
		<p><?php echo nl2br($siteInfo['about']);?></p>
