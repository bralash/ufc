<?php 
    ...
    if($adm->is_loggedin() != ""){
        if(isset($_SESSION['adm_session']) 
            ...
            $genInfo->redirect(BASE_URL.'administrator');
            exit();
        }
    }
    ...
    if(isset($_POST['username'])){
        ...
        elseif($password == ''){
          $error[] = "Please enter your password!"; 
            ...
            if($adm->doLogin($username, $password, $currentTime, $gen_userBrowser, $gen_userOS, $gen_userIP)){
                //Return URL 
                if($returnUrl != "") {
                ...
                $error[] = "Username or Password does not match, Or account not active!";
            }
        }   
    }

    $pageTitle = "Login  - Admin only";
