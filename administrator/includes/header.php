...
<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <?php if(isset($siteInfo['logo_url']) AND $siteInfo['logo_url'] != ''){ 
                $logoURL = BASE_URL.str_replace('../', '', $siteInfo['logo_url']);?>
            <a href="<?php echo BASE_URL;?>" >
            <img style="max-width:250px; max-height: 250px;" src="<?php echo $logoURL;?>" alt="logo"/></a>
            <?php }else{?>
            <a href="<?php echo BASE_URL;?>">
            <img src="<?php echo BASE_URL;?>img/logo.png" alt="logo"/></a>
            <?php }?>
        </div>
    </div>
...
<?php if(!empty($topNotifications)){
    ...
    <?php if($note['status'] == 0){?>
       <a style="background:#f8f8f8;" href="<?php echo BASE_URL.'administrator/'.$note['action_url'].'&marknotfRead='.$note['id'] ;?>" class="list-group-item">
          <div class="media">
       ...
       <hr style="margin:2px;">
    <?php }else{?>
       <a href="<?php echo BASE_URL.'administrator/'.$note['action_url'] ;?>" class="list-group-item">
          <div class="media">
             <div class="pull-left p-r-10">
            <?php if($note['admin'] != ''){?>
                <?php if($admPic['photo'] != ''){?>
...
<?php }}?>
    ...
    <li>
        <a href="<?php echo BASE_URL;?>administrator/notifications" class="list-group-item text-right">
            <small class="font-600">See all notifications</small>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo BASE_URL;?>administrator/admin-profile">
                            <i class="ti-user m-r-5"></i> Profile</a></li>

                            <li><a href="<?php echo BASE_URL;?>administrator/admin-profile-edit">
                            <i class="ti-pencil-alt m-r-5"></i> Edit Profile</a></li>

                            <li><a href="<?php echo BASE_URL;?>administrator/screen-lock">
                            <i class="ti-lock m-r-5"></i> Lock screen</a></li>
