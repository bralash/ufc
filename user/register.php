<?php 
    ...
    if(isset($_POST['firstName'])){
        ...
        if(isset($refInfo['email']) 
            ...
            $error[] = "Opps! No record found for the referral email provided!";
        }
...
<div class="panel-body">
    <form class="form-horizontal m-t-20" action="" method="post">
        ...
        <div class="form-group">
            <div class="col-xs-12">
                <input class="form-control" type="phone" name="phone" required placeholder="Phone Number (eg: +449234567889)" value="<?php if(isset($phone)){echo $phone;}?>">
            </div>
        </div>

        <div class="form-group">
            <div class="col-xs-12">
                <input class="form-control" type="email" name="email" required placeholder="Email Address" value="<?php if(isset($email)){echo $email;}?>">
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-xs-12">
                ...
                <input class="form-control" type="email" name="referral" placeholder="Referral email" value="<?php echo $refEmail;?>">
            </div>
        </div>
        <?php }else{?>
        <div class="form-group">
            <div class="col-xs-12">
                <label>Referral Email</label>
                <input class="form-control" type="email" name="referral" required placeholder="Referral email" value="<?php if(isset($referral)){echo $referral;}?>">
            </div>
        </div>        
        <?php }?>
